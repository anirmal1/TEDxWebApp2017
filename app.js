...
angular.module('tedx-app', [])
	.controller('AppController', function($scope) {
		...
		$scope.sections = [{text:'Schedule', 
							content:'schedule-scroll', 
							items: [{time:'1:30pm', currEvent:'Speaker1'},
									...
									{time:'4:30pm', currEvent:'Entertainment2'}], 
									controller:'ScheduleSectionController'}, 
						   {text:'Speakers', 
						   content:'speakers-scroll', 
						   items: [], 
						   controller:'SpeakerSectionController'}, 
						   {text:'Activities', 
						   content: 'activities-scroll', 
						   items: [], 
